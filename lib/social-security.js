...
export class SocialSecurityCalculator {
  constructor(options = {}) {
    // 2026 bend points (these change annually, but are good approximations)
    this.bendPoint1 = options.bendPoint1 ?? 1286; // Monthly
    this.bendPoint2 = options.bendPoint2 ?? 7749; // Monthly
    this.maxTaxableEarnings = options.maxTaxableEarnings ?? 184500; // 2026 cap
  }
