...
/**
 * Tax year for all parameters in this module.
 * Update this when refreshing brackets/limits for a new year.
 */
export const TAX_YEAR = 2026;

/**
 * Check if tax parameters may be outdated.
 * Returns true if the current calendar year is beyond TAX_YEAR.
 * @returns {boolean}
 */
export function isTaxDataStale() {
  return new Date().getFullYear() > TAX_YEAR;
}

/**
 * Federal tax brackets for single filers (2026)
...
/**
 * Federal tax brackets for married filing jointly (2026)
 * Source: IRS Revenue Procedure 2025-32
 */
export const FEDERAL_TAX_BRACKETS_MFJ_2026 = [
...
/**
 * Social Security parameters (2026)
 * Source: Social Security Administration (2026 COLA fact sheet, Federal Register)
 */
export const SOCIAL_SECURITY_2026 = {
  maxTaxableEarnings: 184500,
  bendPoint1: 1286, // Monthly AIME
  bendPoint2: 7749, // Monthly AIME
  replacement1: 0.9, // First 90%
  replacement2: 0.32, // Next 32%
  replacement3: 0.15, // Final 15%
  colaAdjustment: 0.028, // 2.8% COLA for 2026
};
...
export function calculateFederalTax(taxableIncome, filingStatus = 'single') {
  const brackets =
    filingStatus === 'mfj' ? FEDERAL_TAX_BRACKETS_MFJ_2026 : FEDERAL_TAX_BRACKETS_2026;
